...
theta_all = read.csv("./Scenarios_parameters/theta_all_final_med.csv")
sens = read.csv("./Scenarios_parameters/sens_final_med.csv")
...
# write.table(output, "~/Dropbox/RGNOSIS/Methods/Empiric prescribing model/Model/Output/Final/Sens/Output_empiric_base_antib_med.csv", append=T, sep = ",",row.names=T,col.names=ifelse(i==1,NA,F))
# write.csv(traj, paste0("~/Documents/Esther/RGNOSIS/Methods/Empiric_prescribing_model/Output/Sensitivity analysis/Trajectories/Traj_empiric_base_antib_med_",i,".csv"))
